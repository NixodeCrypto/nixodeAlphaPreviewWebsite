...
declare global {
  ...
  type BRProps = React.DetailedHTMLProps<
  ...
  type DataProps = React.DetailedHTMLProps<
  ...
  type DataListProps = React.DetailedHTMLProps<
  ...
  type DLProps = React.DetailedHTMLProps<
  ...
  type EmbedProps = React.DetailedHTMLProps<
  ...
  type InsProps = React.DetailedHTMLProps<
  ...
  type DelProps = React.DetailedHTMLProps<
  ...
  type ObjectProps = React.DetailedHTMLProps<
  ...
  type ParamProps = React.DetailedHTMLProps<
  ...
  /** Equivalent to `React.DetailedHTMLProps<React.HTMLAttributes<HTMLQuoteElement>, HTMLQuoteElement>` */
  type CiteProps = React.DetailedHTMLProps<
    React.HTMLAttributes<HTMLQuoteElement>,
    HTMLQuoteElement
  >;
  /** Equivalent to `QuotePropsWithoutRef` and `React.HTMLAttributes<HTMLQuoteElement>` */
  ...
  type StyleProps = React.DetailedHTMLProps<
  ...
  type ColProps = React.DetailedHTMLProps<
  ...
  type TableSectionPropsWithoutRef =
    React.HTMLAttributes<HTMLTableSectionElement>;
  ...
  type TemplateProps = React.DetailedHTMLProps<
  ...
  type TrackProps = React.DetailedHTMLProps<
